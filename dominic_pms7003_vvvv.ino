//Internet
#define SECRET_SSID "MAQM SENSOR NETWORK"    // replace MySSID with your WiFi network name
#define SECRET_PASS "bazooka1234@"  // replace MyPassword with your WiFi password

#define SECRET_CH_ID 1916433     // replace 0000000 with your channel number
#define SECRET_WRITE_APIKEY "HMJE1OZ9AY55JWSR"   // replace XYZ with your channel write API Key
